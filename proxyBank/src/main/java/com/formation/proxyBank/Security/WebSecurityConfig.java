...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter{
	...
	protected void configure(HttpSecurity http) throws Exception {
		System.out.println(" je suis dnas la configggggggggggggg");
		http.cors().and().csrf().disable()
        .exceptionHandling().authenticationEntryPoint(unauthorizedHandler).and()
        .sessionManagement().sessionCreationPolicy(SessionCreationPolicy.STATELESS).and()
	.authorizeRequests()
				.antMatchers("/conseillers").hasAnyRole("ADMIN","DIRECTEUR")
				.antMatchers("/conseillers/comptes/*/transfer/?numerocompteBeneficiaire").hasAnyRole("ADMIN","DIRECTEUR","CONSEILLER")
				...
				.antMatchers("/comptes/*").hasAnyRole("ADMIN","DIRECTEUR","CONSEILLER")
				.antMatchers("/comptes-epargne").hasAnyRole("ADMIN","DIRECTEUR","CONSEILLER")
				.antMatchers("/comptes-epargne/*").hasAnyRole("ADMIN","DIRECTEUR","CONSEILLER")
				.antMatchers("/cartes").hasAnyRole("ADMIN","DIRECTEUR","CONSEILLER")
				.antMatchers("/cartes/*").hasAnyRole("ADMIN","DIRECTEUR","CONSEILLER")
				.antMatchers("/agences/*/ajouterEmploye/?idEmploye").hasAnyRole("ADMIN", "DIRECTEUR")
				.antMatchers("/agences/*/employes").hasAnyRole("ADMIN", "DIRECTEUR")
