...
@Api(tags = "Authentification", description = " ")
...
public class AuthController {
	...
	public ResponseEntity<?> registerConseiller(@Valid @RequestBody SignupRequest signUpRequest) {
		...
		Employe user = new Conseiller(signUpRequest.getUsername(), signUpRequest.getEmail(),
	...
	public ResponseEntity<?> registerAdmin(@Valid @RequestBody SignupRequest signUpRequest) {
		...
		Employe user = new Admin(signUpRequest.getUsername(), signUpRequest.getEmail(),
				encoder.encode(signUpRequest.getPassword()), signUpRequest.getNom(), signUpRequest.getPrenom());
	...
	public ResponseEntity<?> registerDirecteur(@Valid @RequestBody SignupRequest signUpRequest) {
		...
		Employe user = new Directeur(signUpRequest.getUsername(), signUpRequest.getEmail(),
				encoder.encode(signUpRequest.getPassword()), signUpRequest.getNom(), signUpRequest.getPrenom());
